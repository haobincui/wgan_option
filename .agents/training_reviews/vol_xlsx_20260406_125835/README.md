...
- `version_info.md`: run configuration, dataset, artifacts, and key metrics
- `issues_found.md`: problems identified from the current run and training workflow
- `modification_suggestions.md`: prioritized implementation and experiment suggestions
