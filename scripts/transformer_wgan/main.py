...
HELP_TEXT = """Usage:
  ...
  python scripts/transformer_wgan/main.py sample --config configs/transformer_wgan/train_default.yaml
  python scripts/transformer_wgan/main.py generate-result --config configs/transformer_wgan/train_default.yaml
