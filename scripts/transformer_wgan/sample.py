"""Standalone generate-result entrypoint for the independent Transformer WGAN module."""
...
from transformer_wgan.config import config_to_dict, load_train_config, parse_sample_overrides  # noqa: E402
...
def build_parser():
    return build_generate_arg_parser(
        description="Generate arbitrage-weighted future surfaces from a trained Transformer WGAN run.",
