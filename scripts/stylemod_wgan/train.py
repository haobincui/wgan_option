"""Standalone training entrypoint for the independent StyleMod WGAN module."""
...
from stylemod_wgan.config import config_to_dict, load_train_config, parse_train_overrides  # noqa: E402
...
def main(argv: list[str] | None = None):
    return run_training_cli(
        argv=argv,
        description="Train or pipeline-run the standalone StyleMod WGAN module.",
