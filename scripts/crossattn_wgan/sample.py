"""Standalone generate-result entrypoint for the independent Cross-Attention WGAN module."""
...
from crossattn_wgan.config import config_to_dict, load_train_config, parse_sample_overrides  # noqa: E402
...
def build_parser():
    return build_generate_arg_parser(
        description="Generate arbitrage-weighted future surfaces from a trained Cross-Attention WGAN run.",
