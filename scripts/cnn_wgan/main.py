...
from scripts.cnn_wgan.generate_result import main as generate_result_main  # noqa: E402
from scripts.cnn_wgan.sample import main as sample_main  # noqa: E402
from scripts.cnn_wgan.train import main as train_main  # noqa: E402

HELP_TEXT = """Usage:
  python scripts/cnn_wgan/main.py train --config configs/cnn_wgan/train_default.yaml
  python scripts/cnn_wgan/main.py sample --config configs/cnn_wgan/sample_default.yaml
