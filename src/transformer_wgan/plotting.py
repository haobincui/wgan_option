"""Standalone plotting helpers for Transformer WGAN generate-result outputs."""
...
def plot_transformer_wgan_payload(payload: Mapping[str, Any], output_path: str | Path) -> Path:
    """Render one standalone Transformer WGAN generate-result payload into PNG files."""
