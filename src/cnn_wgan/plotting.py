"""Standalone plotting helpers for CNN WGAN generate-result outputs."""
...
def plot_cnn_wgan_payload(payload: Mapping[str, Any], output_path: str | Path) -> Path:
    """Render one standalone CNN WGAN generate-result payload into PNG files."""
