"""Standalone plotting helpers for StyleMod WGAN generate-result outputs."""
...
def plot_stylemod_wgan_payload(payload: Mapping[str, Any], output_path: str | Path) -> Path:
    """Render one standalone StyleMod WGAN generate-result payload into PNG files."""
