"""Training-curve plotting helpers for standalone StyleMod WGAN."""
...
def plot_training_curves(
    ...
    *,
    ...
    title: str = "StyleMod WGAN Training Curves",
) -> Path:
    """Render a multi-panel loss-curve figure from standalone StyleMod WGAN metrics."""
