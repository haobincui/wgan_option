"""Standalone plotting helpers for VolGAN generate-result outputs."""
...
def _line_series(
    *,
    current_surface: np.ndarray | None,
    generated_surface: np.ndarray | None,
    target_surface: np.ndarray | None,
    ...
    if target_surface is not None:
        series.append(("Target", target_surface, "#2ca02c"))
    return series


def plot_volgan_payload(payload: Mapping[str, Any], output_path: str | Path) -> Path:
    """Render one standalone VolGAN generate-result payload into PNG files."""
