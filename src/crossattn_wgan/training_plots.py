"""Training-curve plotting helpers for standalone Cross-Attention WGAN."""
...
def plot_training_curves(
    ...
    *,
    ...
    title: str = "Cross-Attention WGAN Training Curves",
) -> Path:
    """Render a multi-panel loss-curve figure from standalone Cross-Attention WGAN metrics."""
