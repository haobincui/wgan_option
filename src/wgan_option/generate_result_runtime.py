...
def run_vol_generation(argv=None) -> "Path":
    """End-to-end vol-surface generation from a trained WGAN checkpoint."""

    import json as _json
    from typing import Optional as _Opt

    from wgan_option.postprocess_runtime import resolve_metrics_artifact_path
...
def run_svi_generation(argv=None) -> "Path":
    """End-to-end SVI param generation, surface reconstruction, and comparison."""
...
def run_vol_regression_generation(argv=None) -> "Path":
    """End-to-end vol-surface generation from a deterministic regression checkpoint."""
