...
config = {
    ...
    "data_path": "data/raw/",  # Path to the dataset directory
    "models_path": "outputs/checkpoints/",  # Path to save trained models
    "outputs_path": "outputs/checkpoints/"  # Path to save outputs
}
